  ...
  public class ClubRepresentationAdapter
  {
    ...
    public ClubRepresentation Representation(Club club)
    {
      var links = new List<Link>()
      {
          ...
          Link.Make("players", this.clubPlayerUriFactory.MakeCollection(club.Id), "Players")
      };
